<template>
  ...
  <div>
    <!-- Need to recalculate odds -->
    <h5>Special Forces: Offense-2D6</h5>
    <ul>
      <li>Vs Infantry: 5-8, 11-12 (55.6%)</li>
      <li>Vs Mech: 7-12 (50%)</li>
      <li>Vs IFV: 7-8, 11-12 (30.56%)</li>
      <li>Vs MBT: 7-12 (50%)</li>
    </ul>
  </div>
  <div>
  ...
  <div>
    ...
    <ul>
      <li>2 tile range on combat board</li>
      <li>1-4 (33%) on all ground targets (1 tile range)</li>
  ...
  <div>
    ...
    <ul>
      ...
      <li>Vs land targets follow artillery rules</li>
