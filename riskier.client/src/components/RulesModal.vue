      ...
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body no-pad mx-2" id="rules">
            ...
            <p class="bg-light">--If the warehouses in a city are full the city will stop producing supplies until more
              warehouses are
            ...
            <p class="bg-light"><strong>--Special Forces</strong> are similar to infantry in that they are defensively
              balanced, but are
              a
            ...
            <p class="bg-light"><strong>--Infantry Fighting Vehicle (IFV)</strong> are essentially light tanks that are
              effective at
            ...
            <p class="bg-light"><strong>--Anti-aircraft</strong> is a players ground defense from aircraft. They can
              fire 2 AA missiles
              at
            ...
            <p class="bg-light"><strong>--SS-Artillery</strong> is a very effective form of artillery but is limited on
              its ammunition
              and
            ...
            <p class="bg-light"><strong>--Fighter Aircraft</strong> provide more flexable AA cover for ground units with
              a limited
              ability
            ...
            <p class="bg-light"><strong>--Supply Aircraft</strong> can deliver supplies by air to ground units and
              transport units
            ...
            <p class="bg-light">--There are 3 types of naval units, Aircraft carrier, Cruiser, and Destroyer. Each unit
              has peg holes in
            ...
            <p class="bg-light"><strong>--Carriers</strong> have the ability to carry up to 8 fighter aircraft and CAS.
              They are durable
            ...
            <p>--If a carrier is destroyed all the aircraft on the ship are destroyed as well unless they are within
            ...
            <p class="bg-light"><strong>--Cruisers</strong> are much more versatile than destroyers, but are not as
              durable or nimble.
            ...
            <p class="bg-light">--Before combat begins be sure to place any item cards face up in front of the player at
              the combat board
              when being used.
            </p>
            ...
            <p class="bg-light">--Infantry/Special forces that occupy fortifications take 2 hits to destroy. If a player
              only lands 1
            ...
            <p class="bg-light">--The offensive player will place their units as close to the defending player as they
              wish. However,
              they
            ...
            <p class="bg-light">--During combat every unit is subject to their environmental rules to determine their
              probabilities of
            ...
            <p class="bg-light">--Any action an aircraft takes when they are within AA range the AA gets to fire 1 shot
              at the aircraft.
            ...
            <p class="bg-light">--Once a unit is locked into combat that unit cannot move until they destroy the enemy
              or are relieved by
              another unit.
            </p>
            ...
            <p class="bg-light">--The defending/offensive players can retreat by moving there units to first row of
              tiles closest to
            ...
            <p class="bg-light">--Fighter Aircraft can retreat instantly and will be returned to any airfield within
              range.
            </p>
            <p>--Combat is resolved once all of a players units are destroyed or the attacker/defender retreats from the
              battlefield.
            </p>
            <p class="bg-light">--If both players declare that they want to end combat before all units have been
              destroyed/retreated
              then
            ...
            <p class="bg-light">--When a player takes territory from another player they must hold that territory for 1
              turn before they
            ...
            <p class="bg-light">--Naval units do not need to occupy the same MB tile to all be included in a naval
              battle. All adjacent
            ...
            <p class="bg-light">--Players start with 3 item cards chosen at random from the deck.
            </p>
            ...
            <p class="bg-light">--Item cards are placed face up in front of the player when using an item card at the
              combat board. The
            ...
            <p class="bg-light"><strong>--Laser Designator:</strong> This item can be used beofre a battle to increase
              the odds of
            ...
            <p class="bg-light"><strong>Point Defense:</strong> The point defense item can be used by a defending player
              before a battle
            ...
            <p class="bg-light"><strong>Surplus Fuel:</strong> This item can be used before a battle begins to upgrade
              mechanized units
            ...
            <p class="bg-light"><strong>Javelin Missiles</strong> : This item card equips infantry units (not SF) with
              effective
              anti-tank
            ...
            <p class="bg-light">--Event cards are cards that are drawn at the end of the 4th players turn. The 4th
            ...
            <p class="bg-light">--Only one structure can occupy any one tile.
            </p>
            <p>--Players capitals act as airfields. Players do not need to build an airfield by their capital.
            </p>
            <p class="bg-light">--Capitals and medium cities produce 1 ammo per turn and can store ammo in warehouses
              when built in
              adjacent tiles.
            </p>
            ...
            <p class="bg-light">--Aircraft can only be built in cities with an adjacent airfield.
            </p>
            ...
            <p class="bg-light">--Fortifications can be built anywhere. One Fortification placed on the game board
              represents 3
            ...
            <p class="bg-light">--Naval Yards can be built on any tile that is next to a water tile. Each naval yard can
              build up to
              three
            ...
            <p class="bg-light">--Army and Division pieces are a way to consolidate large groups of units. Armies are
              groups of 9 units
            ...
            <p class="bg-light">--Divisions and Army groups can instantly capture unnoccupied tiles.
            </p>
          </div>
