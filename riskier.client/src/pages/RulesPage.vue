  ...
  <body class="container-fluid">
    <div class="row">
      ...
      <div class="col-12">
        ...
        <p><span class="text-warning">--Mechanized Infantry (Mechanized)</span> are a heavier more mobile version of
          infantry. They are
          balanced
        ...
        <p><span class="text-warning">--Artillery</span> is a form of indirect fire unless they have special forces
          with a laser designator guiding their shots. Guided shots are much more effective. Artillery have 1 movement
        ...
        <p><span class="text-warning">--Missile-Artillery</span> is a very effective form of artillery but is limited
          on the enemies ability to shoot down missiles. They do not have any defensive
          ability. They have a range of 4 on the combat board.
        </p>
        ...
        <p><span class="text-warning">--Cruisers</span> are much more versatile than destroyers, but are not as
          ...
          targets. Cruiser can provide Missile artillery support on the main board if a laser designator is being used
          and
